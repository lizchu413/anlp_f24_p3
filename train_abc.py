...
class T5Trainer(Trainer, metaclass=ABCMeta):
    ...
    @overrides
    def train_step(self) -> typing.NoReturn:
    ...
    @overrides
    def _generate_outputs_greedy(self, src_ids, src_mask, skip_special_tokens=True) -> typing.Tuple:
    ...
    # overrides
    @overrides
    def _generate_outputs_sampled(self, src_ids, src_mask, batch_size) -> typing.List:
...
def setup_wandb_for_run(local_args, do_symlink=False):
    ...
    #                resume="must")
    # else:
    wandb.login(key="cd01f5e977c52e8ee981cee5fe9f76324f34b386")
